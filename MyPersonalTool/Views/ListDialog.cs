...
/// 支持自定义数据源、文本/可编辑/操作列、工具栏按钮/下拉菜单。
/// </summary>
public static class ListDialog
{
    public static async Task ShowAsync(Window owner, ListDialogConfig config)
    {
    ...
    private static Control BuildToolbarItem(ListToolbarAction action)
    {
